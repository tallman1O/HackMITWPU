...
const AnimatedCard = ({ width = 300, height = 400, image, children }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-5 left-4 tracking-tight font-black text-2xl leading-tight">
        <span className="w-fit block">{children}</span>
      </div>
    </div>
  );
};
