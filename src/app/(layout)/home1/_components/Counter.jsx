...
const Counter = () => {
  return (
    <div className='bg-hack-100 text-white p-4 px-6 rounded-2xl w-[200px]'>
        ...
        <p className='text-3xl font-bold text-accent-100 text-center'>+ <CountUp start={0} end={10000} duration={2} /></p>
...
export const Counter2 = () => {
    return (
      <div className='bg-accent-100 text-white px-6 p-4 rounded-2xl w-[200px]'>
          ...
          <p className='text-3xl font-bold text-hack-100 text-center'>+ <CountUp start={0} end={10000} duration={2} /></p>
